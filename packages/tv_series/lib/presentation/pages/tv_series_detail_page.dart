                            ...
                            Row(
                              children: [
                                Row(
                                  children: [
                                    const Icon(
                                      Icons.watch_later_outlined, color: cYellow,
                                      size: 14,
                                    ),
                                ...
                                Row(
                                  children: [
                                    const Icon(Icons.star, size: 14, color: cYellow,),
                                    const SizedBox(width: 4),
                                    Text(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(_showGenres(tvSeriesDetail.genres),style: TextStyle(color: Colors.white),),
                                    ],
                                  ),
                                ),
                              ],
